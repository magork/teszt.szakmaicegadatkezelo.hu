<?php
	...
	*/
	...
	$ezr->results_heading           = "<font size=2>";
	
	// Single result row
	$ezr->results_row               = "<b>id:</b> COL1<br><b>title:</b> COL2<br><b>price:</b> COL3<br><b>description:</b> COL4<p>";
	
	// Close the results (in this case table)
	$ezr->results_close             = "</font>";
	...
	*/
	...
	// Total Records: 20 ..
	$ezr->show_count                = true;
	$ezr->text_count                = "Browsing All Books";
