...
error_reporting( E_ALL );
		...
		if( !empty( $cats ) ){
			$leker = $db->query("INSERT INTO companies ( id, address, cname, email, region, city, tel, url, brands, description, places, pass, ts, advcat, fax, iso ) VALUES 
                                ( NULL, '$address', '$cname', '$email', '$region', '$city', '$tel', '$url', '$brands', '$description', '$places', '$pass', UNIX_TIMESTAMP(), '$advcat', '$fax', '$iso' ) ");
				...
				<td width="400" valign="top" bgcolor="#ffffff">
					...
					<input type="hidden" name="id" value="'.$id.'" />
						<table width="400" border="0" cellspacing="3" cellpadding="1" bgcolor="">
						  ...
						  <tr>
							<td align="right" valign="top">Egyéb tevékenységek</td>
							<td><textarea name="advcat" cols="30" rows="4" id="description">'.str_replace( "<br />", "\n", $data->advcat).'</textarea></td>
						  </tr>
						  <tr>
							<td align="right" valign="middle"></td>
...
////////////////////////////////////////////////////////
	...
	*/
	...
	function b2b_sendmail( $id )
	{
		...
		$message = "<h3>Tisztelt ".$data->cname.",</h3>Az alábbi jelszóval be tud lépni B2B ajánlatküldő rendszerébe:<br> A jelszó: ".$data->pass." <br> Az alábbi linken a beléptető oldalra kerül.<br><br> <a href='http://www.uzleticegtudakozo.hu'>Tovább az Üzleticégtudakozó oldalára.</a>";
		...
		$mail->CharSet  = "utf-8";
		$mail->From     = 'noreply@uzleticegtedakozo.hu';
		$mail->FromName = "üzleticegtudakozo";
		$mail->Mailer   = "mail";
