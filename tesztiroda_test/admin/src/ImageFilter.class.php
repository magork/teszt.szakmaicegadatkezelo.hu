...
define("IMGCACHE_PATH", "images/tmp/");
...
define("IMAGEMODIFIER_JPEG_QUALITY", 90);
...
class ImageModifier {
    ...
    function execute() {
        if (!$this->isCached()) {
            ...
            if( !$this->_outputformat ) $this->_outputformat = IMAGEMODIFIER_DEFAULT_OUTPUTFORMAT;
