<?php /* V2.10 Template Lite 4 January 2007  (c) 2005-2007 Mark Dickenson. All rights reserved. Released LGPL. 2011-03-29 15:07:53 CEST */ ?><h2>Statisztikák</h2>
		...
		<?php if (count((array)$this->_vars['d']['cegek'])): foreach ((array)$this->_vars['d']['cegek'] as $this->_vars['j']): ?>
			<tr>
				<td><?php echo $this->_vars['j']['cid']; ?>
	        		...
	        		<td> <b><?php echo $this->_vars['j']['portal_name']; ?>
</b> <br> <i><?php echo $this->_vars['j']['pc_date']; ?>
</i> </td>
