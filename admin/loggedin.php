...
function modify( ajdi ) {
	var NewStr = document.getElementById( 'cat' + ajdi ).value;
	var NewStr_en = document.getElementById( 'cat' + ajdi + '_en').value;
	var NewStr_de = document.getElementById( 'cat' + ajdi + '_de').value;
	document.location = 'index.php?do=category_edit&str=' + NewStr + '&str_en=' + NewStr_en + '&str_de=' + NewStr_de + '&id=' + ajdi;
}
...
<?php
	...
	************************ */
				...
				case "category_edit":
					$admin->category_edit( $_GET['str'], $_GET['str_en'], $_GET['str_de'], $_GET['id'] );
				break;
	...
	*************************** */
				...
				case "comp_parse":
					$admin->comp_parse( $_POST['cname'], $_POST['address'], $_POST['places'], $_POST['email'], $_POST['region'], $_POST['city'], $_POST['tel'], $_POST['url'], $_POST['brands'], $_POST['description'], $_POST['description_en'], $_POST['description_de'], $_POST['cat'], $_POST['advcat'], $_POST['advcat_en'], $_POST['advcat_de'], $_POST['fax'], $_POST['iso'] );
				break;
				...
				case "comp_parse_edit":
					if( isset( $_GET['BRSR'] ) ) $page = $_GET['BRSR'];
					$admin->comp_parse_edit( $_POST['id'], $_POST['cname'], $_POST['address'], $_POST['places'], $_POST['email'], $_POST['region'], $_POST['city'], $_POST['tel'], $_POST['url'], $_POST['brands'], $_POST['description'], $_POST['description_en'], $_POST['description_de'],  $_POST['cat'], $page, $_POST['advcat'], $_POST['advcat_en'], $_POST['advcat_de'], $_POST['fax'], $_POST['iso']  );
				break;
